<template>
    <div class="edit-class-modal" @click="close">
        ...
        >
            ...
            <label class="edit-class-modal__form-label">Trainer Id:</label>
            <input 
            ...
            <input 
                ...
                required 
            />
            <label class="edit-class-modal__form-label">Description</label>
            <input 
                class="edit-class-modal__form-input"
                type="text" 
...
@Component
export default class AdminEditClassModal extends Vue {
    public name = 'AdminEditClassModal';
    ...
    initializeFormData() {
        this.trainerId = this.classData.trainer_id;
        this.className = this.classData.name;
        this.classDescription = this.classData.description;
        this.classDate = this.formatDate(this.classData.date);
        this.classStartTime = this.classData.start_time;
        this.classEndTime = this.classData.end_time;
    }
